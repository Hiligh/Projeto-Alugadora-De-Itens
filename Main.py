...
def mostraClientesNoFrame(frameTabela, interfacePrincipal):
    ...
    for i in range(len(db)):
        ...
        if(mesAtual.month == mesVencimentoContrato.month and mesAtual.year == mesVencimentoContrato.year):
            corVencimento = corInterfacePrincipal
            corFonteVencimento = corFonte
            corBordaVencimento = corBordas
            if(mesVencimentoContrato.day == mesAtual.day and datas['statePayment'] != "Pago"):
                corVencimento = "#BDAD1C"
                corFonteVencimento = "white"
                corBordaVencimento = "#FAE40F"
            elif(mesVencimentoContrato.day < mesAtual.day and datas['statePayment'] != "Pago"):
                corVencimento = "#8F0E07"
                corFonteVencimento = "white"
                corBordaVencimento = "#EC170C"
            elif(mesVencimentoContrato.day < mesAtual.day or mesVencimentoContrato.day == mesAtual.day and datas['statePayment'] == "Pago"):
